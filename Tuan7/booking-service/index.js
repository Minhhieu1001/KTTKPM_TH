...
const PORT = 8083;
const MONGODB_URI = process.env.MONGODB_URI || 'mongodb://172.16.34.224:27017/movie_booking_db';
const RABBITMQ_URL = process.env.RABBITMQ_URL || 'amqp://172.16.34.224';
    ...
    channel.consume(q.queue, async (msg) => {
      if (msg.content) {
        ...
        if (event.type === 'PAYMENT_COMPLETED') {
          const update = await Booking.findByIdAndUpdate(event.payload.bookingId, { status: 'CONFIRMED' });
